<template>
  <footer class="bg-[#951d1c] py-2 px-1 mt-5 font-notoSansJP text-center text-white">
    <div class="container mx-auto">
      <div class="flex flex-wrap lg:flex-nowrap">
        <div class="w-1/4 px-4 mb-6 lg:mb-0 lg:text-base text-xs">
          <h4 class=" font-medium  mb-2 border-b-2 border-white pb-2 inline-block ">
            ¡Encontranos!
          </h4>
          <ul class="list-none p-0 m-0">
            <li>Lunes a Sábado de 8 hs a 20 hs Av. Monteagudo 1969</li>
          </ul>
        </div>
        <div class="w-1/4 px-4 mb-6 lg:mb-0 lg:text-base text-xs">
          <h4 class="font-medium  mb-2 border-b-2 border-white pb-2 inline-block">
        ...
        <div class="w-1/4 px-4 mb-6 lg:mb-0 lg:text-base text-xs">
          ...
          <ul class="list-none p-0 m-0">
            <li><a href="/Home" class=" hover:text-[#FAF298] transition-colors">Inicio</a></li>
            <li><a href="/Productos" class=" hover:text-[#FAF298] transition-colors">Productos</a></li>
            <li><a href="/Nosotros" class=" hover:text-[#FAF298] transition-colors">Nosotros</a></li>
            <li><a href="/Contacto" class=" hover:text-[#FAF298] transition-colors">Contacto</a></li>
          </ul>
        </div>
        <div class="w-1/4 px-4 mb-6 lg:mb-0 lg:text-base text-xs">
          <h4 class="font-medium  mb-2 border-b-2 border-white pb-2 inline-block">
    ...
    <div class="mt-3 border-t border-gray-300 text-xs text-start">
      <p class="ml-5">© 2024 Martin y Sofia. Todos los derechos reservados.</p>
    </div>
  </footer>
</template>
